        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          ...
          <div className="space-y-4">
            {data.recommendations.map((recommendation, index) => (
              <div
                key={index}
                className="flex items-start space-x-3 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-200 hover:shadow-md transition-all duration-200"
              >
                <div className="flex-shrink-0 w-6 h-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full flex items-center justify-center text-sm font-medium">
                  {index + 1}
                </div>
          ...
          <div className="mt-6 p-4 bg-gradient-to-r from-green-50 to-blue-50 rounded-lg border border-green-200">
            ...
            <p className="text-sm text-gray-600">
              These recommendations are generated by analyzing multiple scenarios and comparing their environmental impact against your current configuration.
            </p>
          </div>
        </div>
